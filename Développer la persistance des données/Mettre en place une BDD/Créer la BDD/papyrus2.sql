...
CREATE INDEX `nom_entcom` ON `entcom` (`numfou`);
CREATE USER 'util1'@'localhost' IDENTIFIED BY 'hahaha';
CREATE USER 'util2'@'localhost' IDENTIFIED BY 'hihihi';
CREATE USER 'util3'@'localhost' IDENTIFIED BY 'hohoho';
...
LOAD DATA LOCAL INFILE  'C:\\Users\\80010-80-04\\Downloads\\vente.csv'
INTO TABLE vente
