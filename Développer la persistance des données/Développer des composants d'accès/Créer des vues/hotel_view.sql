...
CREATE VIEW v_listehotels
AS
SELECT hot_nom, hot_sta_id
FROM hotel;

--2

CREATE VIEW v_listecha_hot
AS
SELECT cha_numero, cha_hot_id
FROM chambre;

--3

CREATE VIEW v_resaclient
AS 
...
CREATE VIEW v_listecha_hot_sta
AS
